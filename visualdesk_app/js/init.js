...
$(function () { // DOM ready
  ...
  $("#hs_button").click(function() {
    ...
    var highscores = "Top 10 High Score Table:\n\n"
  ...
  $("#name_button").click(function(){
    player_name_prompt = prompt("What's your name?","");
    console.log("New score: " + $("#current_score_num").html());
    ...
    gameScore.save(null, {
      success: function(gameScore) {
        ...
        if (debug_mode) {
          ...
          alert("Score successfully sent to the high-score table!");
        }
      },
  ...
  if (chaine_trouvee) {
    ...
    if ($icone == undefined && $binome == undefined) {
      if (test_possible_move()) {
        ...
        // tracking Google Analytics
        _gaq.push(['_trackEvent', 'Diamond Fusion', 'Game over', 'Game over', score]);
